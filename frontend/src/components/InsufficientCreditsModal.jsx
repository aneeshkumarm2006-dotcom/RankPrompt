...
const InsufficientCreditsModal = ({ isOpen, onClose, creditsNeeded, creditsAvailable }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-25 flex items-center justify-center z-50">
      <div className="bg-[#F8FAFC] rounded-lg p-6 max-w-md w-full mx-4 border border-gray-200">
        {/* Header */}
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold text-gray-800">Insufficient Credits</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="mb-6">
          ...
          <div className="bg-white rounded-lg p-4 space-y-2">
            <div className="flex justify-between text-sm">
              ...
              <span className="text-gray-800 font-semibold">{creditsNeeded}</span>
            </div>
            <div className="flex justify-between text-sm">
            ...
            <div className="border-t border-gray-200 pt-2 mt-2">
              <div className="flex justify-between text-sm">
                <span className="text-gray-600">Credits Short:</span>
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="flex-1 px-4 py-3 bg-[#4F46E5] hover:bg-purple-700 text-white rounded-lg transition-colors flex items-center justify-center gap-2"
          >
