...
const Hero = () => {
  return (
    <div className="relative pt-24 sm:pt-28 md:pt-32 pb-12 sm:pb-16 md:pb-20 px-4 sm:px-6 lg:px-8 bg-white min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6 sm:space-y-8 animate-slide-right">
            {/* Badge */}
            <div className="inline-flex items-center space-x-2 bg-purple-100 px-5 py-2.5 rounded-full text-sm font-medium animate-slide-down">
              <Sparkles className="w-4 h-4 text-purple-600" />
              <span className="text-gray-800">AI-Powered Brand Visibility</span>
              <Star className="w-3 h-3 text-yellow-400 fill-yellow-400" />
            </div>
            
            {/* Heading */}
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-[1.1] tracking-tight">
              <span className="text-gray-800">Dominate</span>
              <br />
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button className="bg-[#4F46E5] text-white px-8 py-4 rounded-2xl font-bold hover:bg-purple-700 transition-all duration-300 flex items-center justify-center space-x-2">
                <span>Start Free Analysis</span>
                <ArrowRight className="w-5 h-5 group-hover:translate-x-2 transition-transform" />
              </button>
              <button className="bg-gray-100 text-gray-800 px-8 py-4 rounded-2xl font-semibold hover:bg-gray-200 transition-all duration-300 flex items-center justify-center space-x-2 group">
            ...
            <div className="grid grid-cols-3 gap-4 sm:gap-6 md:gap-8 pt-8 sm:pt-10 md:pt-12">
              <div className="space-y-1 sm:space-y-2">
                ...
                <div className="text-xs sm:text-sm text-gray-600">Queries Tracked</div>
              </div>
              <div className="space-y-1 sm:space-y-2">
                <div className="text-2xl sm:text-3xl md:text-4xl font-black gradient-text">10K+</div>
                <div className="text-xs sm:text-sm text-gray-600">Brands Analyzed</div>
              </div>
              <div className="space-y-1 sm:space-y-2">
                <div className="text-2xl sm:text-3xl md:text-4xl font-black gradient-text">4+</div>
                <div className="text-xs sm:text-sm text-gray-600">AI Platforms</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative animate-slide-left hidden lg:block">
            ...
            {/* Main Card */}
            <div className="relative z-10 bg-white border border-gray-200 rounded-2xl sm:rounded-3xl p-4 sm:p-6 space-y-3 sm:space-y-4 shadow-lg">
              {/* Header */}
              <div className="flex items-center justify-between mb-3 sm:mb-4">
                <h3 className="text-gray-800 font-bold text-base sm:text-lg">Live Rankings</h3>
                <div className="px-2 sm:px-3 py-0.5 sm:py-1 bg-green-100 rounded-full border border-green-200">
              ...
              <div className="space-y-2 sm:space-y-3">
                {/* Card 1 */}
                <div className="bg-gray-50 p-3 sm:p-4 rounded-lg sm:rounded-xl hover:bg-gray-100 transition-all duration-300 group border border-purple-200">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2 sm:space-x-3">
                      ...
                      <div>
                        <div className="font-bold text-gray-800">ChatGPT</div>
                        <div className="text-sm text-gray-600">Ranking #1</div>
                      </div>
                    </div>
                ...
                {/* Card 2 */}
                <div className="bg-gray-50 p-4 rounded-xl hover:bg-gray-100 transition-all duration-300 group border border-gray-200">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <div className="font-bold text-gray-800">Gemini</div>
                        <div className="text-sm text-gray-600">Ranking #2</div>
                      </div>
                    </div>
                    <div className="text-right">
                ...
                <div className="bg-gray-50 p-4 rounded-xl hover:bg-gray-100 transition-all duration-300 group border border-gray-200">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <div className="font-bold text-gray-800">Claude</div>
                        <div className="text-sm text-gray-600">Ranking #3</div>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="text-gray-800 font-bold text-lg">87%</div>
                      <div className="flex items-center space-x-1 text-xs text-green-500">
                        <TrendingUp className="w-3 h-3" />
                        <span>+5%</span>
                      </div>
              ...
              <div className="mt-6 p-5 bg-gray-50 rounded-xl">
                <div className="flex items-center justify-between mb-4">
                  <div className="text-sm font-semibold text-gray-800">Visibility Trend</div>
