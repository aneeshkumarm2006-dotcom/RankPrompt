...
const SaveBrandModal = ({ isOpen, onClose, brandData, onSave, onSkip }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-dark-900 rounded-xl sm:rounded-lg max-w-md w-full border border-gray-200 dark:border-dark-700 shadow-2xl">
        {/* Header */}
        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <button
              onClick={onSkip}
              className="flex-1 bg-gray-200 dark:bg-dark-700 hover:bg-gray-300 dark:hover:bg-dark-600 text-gray-800 dark:text-gray-200 font-medium py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg transition-colors text-sm sm:text-base"
            >
              No, Skip
            </button>
          </div>
