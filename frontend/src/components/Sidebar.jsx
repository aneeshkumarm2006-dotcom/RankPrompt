          ...
          {menuItems.map((item) => (
            <div key={item.name}>
              {item.border ? (
                <Link
                  to={item.path}
                  className={`flex items-center justify-between p-3 rounded-xl border-2 border-white/20 transition-all group hover:border-white/40 ${isActive(item.path) ? 'bg-white/10 dark:bg-dark-700/50 border-white/40 dark:border-dark-600' : ''
                    }`}
                >
                  <div className="flex items-center space-x-3">
                ...
                <>
                  <Link
                    to={item.path}
                    className={`flex items-center justify-between p-3 rounded-xl transition-all group hover:bg-white/10 dark:hover:bg-dark-800/50 ${isActive(item.path) ? 'bg-white/10 dark:bg-dark-700' : ''
                      }`}
                    onClick={closeMobileMenu}
                  >
                    <div className="flex items-center space-x-3">
