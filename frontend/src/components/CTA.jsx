...
const CTA = () => {
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-50 to-indigo-100 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="relative max-w-5xl mx-auto">
        <div className="relative bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-10 lg:p-16 text-center border border-gray-200 overflow-hidden shadow-lg">
          ...
          <div className="relative z-10 space-y-6 sm:space-y-8">
            {/* Badge */}
            <div className="inline-flex items-center space-x-2 bg-purple-100 px-5 py-2.5 rounded-full text-sm font-medium animate-bounce-slow">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center pt-4 sm:pt-6">
              ...
              <button className="bg-white text-gray-800 px-6 sm:px-8 md:px-10 py-3 sm:py-4 md:py-5 rounded-xl sm:rounded-2xl font-bold text-base sm:text-lg hover:bg-gray-100 transition-all duration-300 border border-gray-300">
                Schedule Demo
              </button>
            </div>
            ...
            <div className="pt-8 sm:pt-12 flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-8 text-xs sm:text-sm">
              <div className="flex items-center space-x-3">
                <div className="flex -space-x-3">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-primary-400 to-primary-600 border-2 border-white" />
            ...
            {/* Trust Badges */}
            <div className="pt-6 sm:pt-8 flex flex-wrap items-center justify-center gap-3 sm:gap-6 text-xs text-gray-600">
