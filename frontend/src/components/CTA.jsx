  ...
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-50 to-indigo-100 dark:from-dark-800 dark:to-dark-950 relative overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto">
        <div className="relative bg-white dark:bg-dark-900 rounded-2xl sm:rounded-3xl p-6 sm:p-10 lg:p-16 text-center border border-gray-200 dark:border-dark-700 overflow-hidden shadow-lg">
          ...
          <div className="relative z-10 space-y-6 sm:space-y-8">
            {/* Badge */}
            <div className="inline-flex items-center space-x-2 bg-purple-100 dark:bg-purple-500/10 px-5 py-2.5 rounded-full text-sm font-medium animate-bounce-slow">
              <Zap className="w-4 h-4 text-purple-600" />
              <span className="text-gray-800 dark:text-purple-300">Limited Time Offer</span>
            ...
            <div className="pt-8 sm:pt-12 flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-8 text-xs sm:text-sm">
              <div className="flex items-center space-x-3">
                <div className="flex -space-x-3">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-primary-400 to-primary-600 border-2 border-white dark:border-dark-900" />
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-purple-400 to-purple-600 border-2 border-white dark:border-dark-900" />
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-pink-400 to-pink-600 border-2 border-white dark:border-dark-900" />
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-orange-400 to-orange-600 border-2 border-white dark:border-dark-900 flex items-center justify-center text-xs font-bold text-white">
                    +10K
                  </div>
                </div>
                <span className="text-gray-800 dark:text-white font-semibold">Trusted by thousands</span>
              </div>
            ...
            {/* Trust Badges */}
            <div className="pt-6 sm:pt-8 flex flex-wrap items-center justify-center gap-3 sm:gap-6 text-xs text-gray-600 dark:text-gray-400">
