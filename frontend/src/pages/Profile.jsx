      ...
      <div className="flex-1 lg:ml-64 p-3 sm:p-6 md:p-8 mt-16 lg:mt-0">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-4 sm:mb-6">
            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-black text-gray-800">Account</h1>
          </div>

          {/* User Profile Card - Mobile First */}
          <div className="bg-white border border-gray-200 rounded-lg sm:rounded-xl mb-4 sm:mb-6 overflow-hidden">
            <div className="p-3 sm:p-5">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 bg-[#4F46E5] text-white font-medium px-4 py-2.5 rounded-lg transition-all text-sm w-full"
              >
          ...
          <div className="bg-white border border-gray-200 rounded-t-lg sm:rounded-t-xl border-b-0 mb-0">
          ...
          <div className="bg-white border border-gray-200 rounded-b-lg sm:rounded-b-xl p-3 sm:p-5">
            {activeTab === 'overview' && (
              <div className="space-y-4 sm:space-y-6">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="text-base sm:text-lg font-bold text-gray-800">Credits</h3>
                  </div>
                  <div className="bg-gray-100 rounded-lg sm:rounded-xl p-3 sm:p-4">
                    <div className="text-center mb-3 sm:mb-4">
                      <p className="text-gray-600 text-xs sm:text-sm mb-1">Available Credits</p>
                      <p className="text-3xl sm:text-4xl font-bold text-gray-800">{creditData.availableCredits}</p>
                    </div>
                    ...
                    <div className="space-y-2 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-3 text-xs">
                      <div className="bg-gray-100 rounded-lg p-2 sm:p-2.5">
                        <p className="text-gray-500 mb-0.5">Cycle Started</p>
                        <p className="text-gray-800 font-medium">{creditData.billingCycleStarted}</p>
                      </div>
                      <div className="bg-gray-100 rounded-lg p-2 sm:p-2.5">
                        <p className="text-gray-500 mb-0.5">Last Reset</p>
                        <p className="text-gray-800 font-medium">{creditData.lastCreditReset}</p>
                      </div>
                      <div className="bg-gray-100 rounded-lg p-2 sm:p-2.5">
                        <p className="text-gray-500 mb-0.5">Monthly Built</p>
                        <p className="text-gray-800 font-medium">{creditData.monthlyCreditsBuilt}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="text-base sm:text-lg font-bold text-gray-800">Free Trial</h3>
                  </div>
                  <div className="bg-gray-100 rounded-lg sm:rounded-xl p-3 sm:p-4">
                    <p className="text-gray-600 text-xs sm:text-sm mb-3 leading-relaxed">
                      <span className="text-gray-800 font-semibold">7-Day Trial</span> + <span className="text-amber-400 font-semibold">10 Credits</span> • No card required
                    </p>
                    <div className="grid grid-cols-3 gap-2 mb-3">
                      <div className="bg-gray-100 rounded-lg p-2 text-center">
                        <p className="text-green-400 text-lg mb-0.5">✓</p>
                        <p className="text-gray-600 text-xs">7 Days</p>
                      </div>
                      <div className="bg-gray-100 rounded-lg p-2 text-center">
                        <p className="text-green-400 text-lg mb-0.5">✓</p>
                        <p className="text-gray-600 text-xs">10 Credits</p>
                      </div>
                      <div className="bg-gray-100 rounded-lg p-2 text-center">
                        <p className="text-green-400 text-lg mb-0.5">✓</p>
                        <p className="text-gray-600 text-xs">Full Access</p>
                      </div>
                    </div>
                    <button
                      onClick={handleStartTrial}
                      className="w-full bg-[#4F46E5] text-white font-bold py-2.5 sm:py-3 rounded-lg transition-all text-sm"
                    >
                      Start Free Trial
                    </button>
                  </div>
                ...
                <div className="hidden sm:block">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="text-base sm:text-lg font-bold text-gray-800">Credit Breakdown</h3>
                  </div>
                    ...
                    <div className="bg-gray-100 rounded-lg sm:rounded-xl p-3 sm:p-4">
                      <div className="flex items-center justify-between mb-1 sm:mb-2">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-gray-800 font-medium text-xs sm:text-sm">Monthly Plan</span>
                        </div>
                    ...
                    <div className="bg-gray-100 rounded-lg sm:rounded-xl p-3 sm:p-4">
                      <div className="flex items-center justify-between mb-1 sm:mb-2">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-gray-800 font-medium text-xs sm:text-sm">Top-up</span>
                        </div>
                        <span className="text-gray-800 font-bold text-sm">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="text-base sm:text-lg font-bold text-gray-800">Subscription</h3>
                  </div>
                  <div className="bg-gray-100 rounded-lg sm:rounded-xl p-3 sm:p-4">
                    <div className="space-y-2 mb-3">
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600 text-xs sm:text-sm">Plan</span>
                        <span className="text-gray-800 font-semibold text-sm">{accountData.currentPlan}</span>
                      </div>
                      <div className="flex justify-between items-center">
            ...
            {activeTab === 'credit-log' && (
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-base sm:text-lg font-bold text-gray-800">Activity</h3>
                </div>
                {loading ? (
                  ...
                  <div className="space-y-2">
                    {creditActivity.map((log) => (
                      <div key={log._id} className="bg-gray-100 rounded-lg p-3">
                        <div className="flex items-start justify-between gap-3 mb-2">
                          <div className="flex-1 min-w-0">
                            <p className="text-gray-800 font-medium text-xs sm:text-sm leading-tight">{log.description}</p>
            ...
            {activeTab === 'subscription-invoices' && (
              <div>
                <div className="bg-gray-100 rounded-lg p-5 sm:p-8 text-center border border-gray-200">
                  ...
                  <h4 className="text-gray-800 font-bold text-sm sm:text-base mb-2">Invoices & Receipts</h4>
